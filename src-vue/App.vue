...
import { type BreakStyle, fmtMmss } from '@/lib/types'
    ...
    <div class="desktop-layout">
      ...
      <main class="settings-content">
        <section id="overview" class="overview-section">
          ...
          <h1>{{ greeting }}</h1>
          <p class="intro">
            Your eye-break routine is ready when you are. Make it fit your workday without leaving
            your desktop.
          </p>
          ...
          <div class="overview-grid">
            ...
            <article class="rule-card">
              ...
              <div class="rule-steps">
                <div class="rule-step">
                  <b>{{ settings ? Math.round(settings.workSecs / 60) : 30 }}</b><span>minutes</span
                  ><small>Focus before a break</small>
                </div>
                <div class="rule-step">
                  <b>30</b><span>feet away</span><small>Shift your gaze</small>
                </div>
                <div class="rule-step">
                  <b>{{ settings ? settings.breakSecs : 30 }}</b><span>seconds</span
                  ><small>Let your eyes rest</small>
                </div>
              </div>
            </article>
          </div>
        ...
        <template v-if="settings">
          <section id="timing" class="setting-section">
            <div class="section-heading">
              <div>
                <h2>Timing</h2>
                <p>A pace that fits your workday.</p>
              </div>
            </div>
            <article class="settings-card">
              ...
              <div class="setting-row">
                <div>
                  <h3>Snooze length</h3>
                  <p>Extra time when you are not ready yet.</p>
                </div>
                <label class="number-field"
                  ><input
                    type="number"
          ...
          <section id="presence" class="setting-section two-column-section">
            <div class="section-heading">
              <div>
                <h2>Focus &amp; presence</h2>
                <p>Keep IRYS helpful, never disruptive.</p>
              </div>
            </div>
            <div class="settings-columns">
              <article class="settings-card">
                <div class="card-title">
                  <h3>Reminder</h3>
                  <p>How IRYS gets your attention.</p>
                </div>
                <div class="setting-row">
                  <div>
                    <h3>Reminder style</h3>
                    <p>Full screen or a small corner card.</p>
                  </div>
                ...
                <div class="setting-row">
                  <div>
                    <h3>Heads-up notification</h3>
                    <p>A gentle nudge 30 seconds early.</p>
                  </div>
                  <input
                    class="switch"
                    type="checkbox"
                    :checked="settings.prewarn"
                    aria-label="Heads-up notification"
                ...
                <div class="setting-row">
                  <div>
                    <h3>Chime</h3>
                    <p>A soft tone when a break begins.</p>
                  </div>
                  <input
                    class="switch"
                    type="checkbox"
              ...
              <article class="settings-card">
                <div class="card-title">
                  ...
                  <p>Let your screen take priority.</p>
                </div>
                <div class="setting-row">
                  <div>
                    <h3>Skip when I’m away</h3>
                    <p>Reset the interval if you have been idle.</p>
                  </div>
                  <input
                    class="switch"
                    type="checkbox"
                    :checked="settings.skipWhenIdle"
                    aria-label="Skip when I am away"
                ...
                <div class="setting-row">
                  <div>
                    <h3>Away after</h3>
                    <p>Idle time that counts as away.</p>
                  </div>
                  <label class="number-field"
                    ><input
                      type="number"
                ...
                <div class="setting-row">
                  <div>
                    <h3>Wait for full-screen apps</h3>
                    <p>Defer breaks during calls, presentations and games.</p>
                  </div>
                  <input
                    class="switch"
                    type="checkbox"
                    :checked="settings.deferOnFullscreen"
                    aria-label="Wait for full-screen apps"
          ...
          <section id="system" class="setting-section">
            <div class="section-heading">
              <div>
                <h2>System</h2>
                <p>How IRYS fits into Windows.</p>
              </div>
            </div>
            <article class="settings-card">
              <div class="setting-row">
                <div>
                  ...
                  <p>Start your routine when you sign in. No administrator access is needed.</p>
                </div>
                <input
                  class="switch"
                  type="checkbox"
              ...
              <div class="setting-row">
                <div>
                  <h3>About IRYS</h3>
                  <p>Version 0.1.2 · Your settings are saved automatically.</p>
                </div>
                <button class="secondary" type="button" @click="quit()">Quit IRYS</button>
              </div>
            </article>
          </section>
        </template>
...
.titlebar {
  ...
  background: color-mix(in srgb, var(--titlebar) 88%, transparent);
...
.settings-content {
  ...
  padding: 32px clamp(28px, 4vw, 62px) 44px;
  overflow: auto;
...
.next-card {
  padding: 22px;
  background: linear-gradient(125deg, var(--accent-wash), var(--surface) 68%);
}
.next-card.paused {
  background: linear-gradient(125deg, var(--paused-wash), var(--surface) 68%);
}
.status-time {
  display: block;
  margin-top: 5px;
...
.rule-card-heading {
  ...
  background: linear-gradient(120deg, var(--accent-wash), var(--surface) 68%);
...
.settings-card .setting-row:first-of-type {
  border-top: 0;
}
.card-title + .setting-row {
  border-top: 0;
}
.setting-row h3 {
  margin: 0;
