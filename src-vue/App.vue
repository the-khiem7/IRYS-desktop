  ...
  <div class="settings-shell">
    ...
    <div class="desktop-layout">
      <aside class="sidebar" aria-label="Settings navigation">
        ...
        <p class="sidebar-foot">IRYS 0.1.0<br />Your preferences stay on this device.</p>
      </aside>
        ...
        <section id="overview" class="overview-section">
          ...
          <div class="overview-grid">
            ...
            <article class="rule-card">
              ...
              <h2>30–30–30</h2>
              <p>Every 30 minutes, look 30 feet away for 30 seconds.</p>
              <div class="rule-numbers" aria-label="30 minutes, 30 feet, 30 seconds">
                <span><b>30</b>min</span><span><b>30</b>ft</span><span><b>30</b>sec</span>
              </div>
            </article>
          </div>
        </section>
        ...
        <template v-if="settings">
          ...
          <section id="system" class="setting-section">
            ...
            <article class="settings-card">
              ...
              <div class="setting-row"><div><h3>About IRYS</h3><p>Version 0.1.0 · Your settings are saved automatically.</p></div><button class="secondary" type="button" @click="quit()">Quit IRYS</button></div>
            </article>
          </section>
        </template>
...
.rule-card { padding:22px; }.rule-card h2 { margin:4px 0 0; font-size:28px; letter-spacing:-.035em; }.rule-numbers { display:flex; gap:8px; }.rule-numbers span { display:grid; gap:1px; min-width:58px; padding:7px 9px; color:var(--text-dim); background:var(--subtle-fill); border-radius:4px; font-size:11px; }.rule-numbers b { color:var(--accent); font-size:17px; line-height:1; }
